...
export function TextParticle({
  ...
  useEffect(() => {
    ...
    const initText = () => {
      ...
      for (let yy = 0; yy < textCoordinates.height; yy += particleDensity) {
        for (let xx = 0; xx < textCoordinates.width; xx += particleDensity) {
          const index = (yy * textCoordinates.width + xx) * 4
